class ABHIChatRealtime {
    ...
    async init() {
        ...
        console.log('🚀 ABHI Chat initialized - Cross-device ready with offline sync!');
    }
    ...
    setupEventListeners() {
        ...
        document.addEventListener('visibilitychange', () => {
            if (document.hidden) {
                ...
                // Sync messages when user comes back to the app
    ...
    handleConnection(conn) {
        ...
        conn.on('open', () => {
            ...
            // Send initial handshake and sync offline messages
            this.sendToPeer({
                type: 'handshake',
            ...
            // Immediately sync offline messages when connected
            setTimeout(() => {
                this.syncOfflineMessages();
            }, 1000);
    ...
    handleIncomingData(data) {
        switch (data.type) {
            ...
            case 'handshake':
                ...
                this.updateConnectionStatus('Connected', 'online');
                // Sync offline messages after handshake
                setTimeout(() => {
                    this.syncOfflineMessages();
                }, 500);
                break;
            ...
            this.messagesContainer.innerHTML = `
                <div class="welcome-message">
                    ...
                    <div class="connection-info">
                        ...
                        <span>Cross-device messaging with offline sync</span>
                    </div>
                </div>
            `;
        } else {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('🎉 ABHI Chat loaded with offline message sync!');
});
